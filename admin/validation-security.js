...
class AdminDashboardSecurity {
    ...
    addCSP() {
        ...
        if (!head.querySelector('meta[http-equiv="Content-Security-Policy"]')) {
            ...
            meta.setAttribute('content', "default-src 'self'; script-src 'self' 'unsafe-inline'; style-src 'self' 'unsafe-inline'; img-src 'self' data: https:; font-src 'self' data:; connect-src 'self' https://two41runners-api.onrender.com;");
            head.appendChild(meta);
        }
    }
